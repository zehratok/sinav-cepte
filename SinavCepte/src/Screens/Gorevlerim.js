...
const Gorevlerim = (props) => {
  ...
  useEffect(() => {
    axios.get(`https://b4de-149-140-154-149.eu.ngrok.io/gorevlerim/${kullanici.id}`).then((response) => {
                                ...
                                [
                                  {
                                    text: "Sil",
                                    onPress: () => {
                                      axios.delete(`https://b4de-149-140-154-149.eu.ngrok.io/gorevlerim/${gorev.id}`);
                                    }
                                  },
                                  {
                                    text: "İptal",
